        ...
        <div class="col-sm-12">
            ...
            <form method="post" action="/create">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="phone" class="form-control" id="inputPhone" placeholder="789933353" required="">
                </div>
                <div class="form-group">
                    <label for="inputComment">Comment</label>
                    <input type="text" name="comment" class="form-control" id="inputComment" placeholder="Some text">
                </div>
